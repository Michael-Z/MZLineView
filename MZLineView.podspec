...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of MZLineView in Markdown format.
  ...
  # Or just: s.author    = "zhangzhihui"
  # s.authors            = { "zhangzhihui" => "xxhmichael@gmail.com" }
  # s.social_media_url   = "http://twitter.com/zhangzhihui"
